...
export default function Login({setUser}){
    ...
    return (
        <div className="d-flex justify-content-center align-items-center vh-100" style={{background: "#eef5ff"}}>
            <div className="card shadow p-4" style={{width: "380px", borderRadius: "18px"}}>
                <h2 className="text-center mb-4" style={{fontWeight: 700, color: "#2f6fed"}}>
                    Viva Bem
                </h2>

                <form onSubmit={handleLogin}>
                    {erro && (
                        <div className="alert alert-ganger py-2">{erro}</div>
                    )}
                    ...
                    <div className="mb-3">
                        ...
                        <input
                           ...
                           required
                           placeholder="seuemail@gamil.com"
                        />
                    </div>
